...
export default function ModalWorkHour({
  ...
  return (
    <div
      ...
      className={`${
        showModal ? "" : "hidden"
      } flex bg-black bg-opacity-50 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}
    >
      <form onSubmit={submit}>
        <div className="relative p-4 w-full max-w-2xl max-h-full">
          <div className="relative bg-white border-r border-first shadow-sm shadow-first rounded-lg">
